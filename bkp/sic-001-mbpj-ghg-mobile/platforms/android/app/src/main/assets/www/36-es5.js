...
/* harmony import */ var _index_6f647ec8_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./index-6f647ec8.js */ "./node_modules/@ionic/core/dist/esm-es5/index-6f647ec8.js");
...
/* harmony import */ var _index_6941d9b4_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./index-6941d9b4.js */ "./node_modules/@ionic/core/dist/esm-es5/index-6941d9b4.js");
...
var Menu = /** @class */ (function () {
    function class_1(hostRef) {
        ...
        this.lastOnEnd = 0;
        this.blocker = _index_6f647ec8_js__WEBPACK_IMPORTED_MODULE_6__["GESTURE_CONTROLLER"].createBlocker({ disableScroll: true });
        ...
        this.ionWillOpen = Object(_index_26ec602c_js__WEBPACK_IMPORTED_MODULE_1__["d"])(this, "ionWillOpen", 7);
        this.ionWillClose = Object(_index_26ec602c_js__WEBPACK_IMPORTED_MODULE_1__["d"])(this, "ionWillClose", 7);
        this.ionDidOpen = Object(_index_26ec602c_js__WEBPACK_IMPORTED_MODULE_1__["d"])(this, "ionDidOpen", 7);
        this.ionDidClose = Object(_index_26ec602c_js__WEBPACK_IMPORTED_MODULE_1__["d"])(this, "ionDidClose", 7);
        this.ionMenuChange = Object(_index_26ec602c_js__WEBPACK_IMPORTED_MODULE_1__["d"])(this, "ionMenuChange", 7);
    }
    ...
    class_1.prototype.sideChanged = function () {
        this.isEndSide = Object(_helpers_d8b49b57_js__WEBPACK_IMPORTED_MODULE_3__["i"])(this.side);
    };
                ...
                switch (_b.label) {
                    case 0:
                        if (this.type === undefined) {
                            this.type = _ionic_global_1bf1fa84_js__WEBPACK_IMPORTED_MODULE_2__["c"].get('menuType', 'overlay');
                        }
                        el = this.el;
                        ...
                        _index_6941d9b4_js__WEBPACK_IMPORTED_MODULE_8__["m"]._register(this);
                        _a = this;
    ...
    class_1.prototype.disconnectedCallback = function () {
        ...
        _index_6941d9b4_js__WEBPACK_IMPORTED_MODULE_8__["m"]._unregister(this);
        if (this.animation) {
    ...
    class_1.prototype.setOpen = function (shouldOpen, animated) {
        if (animated === void 0) { animated = true; }
        return _index_6941d9b4_js__WEBPACK_IMPORTED_MODULE_8__["m"]._setOpen(this, shouldOpen, animated);
    };
            ...
            return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"])(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        _a = this;
                        return [4 /*yield*/, _index_6941d9b4_js__WEBPACK_IMPORTED_MODULE_8__["m"]._createAnimation(this.type, this)];
                    case 1:
                        // Create new animation
                        _a.animation = _b.sent();
                        if (!_ionic_global_1bf1fa84_js__WEBPACK_IMPORTED_MODULE_2__["c"].getBoolean('animated', true)) {
    ...
    class_1.prototype.canStart = function (detail) {
        ...
        else if (_index_6941d9b4_js__WEBPACK_IMPORTED_MODULE_8__["m"]._getOpenSync()) {
            return false;
        }
    ...
    class_1.prototype.onStart = function () {
        if (!this.isAnimating || !this.animation) {
            Object(_helpers_d8b49b57_js__WEBPACK_IMPORTED_MODULE_3__["b"])(false, 'isAnimating has to be true');
            return;
        }
    ...
    class_1.prototype.onEnd = function (detail) {
         ...
         */
        newStepValue += Object(_cubic_bezier_685f606a_js__WEBPACK_IMPORTED_MODULE_5__["g"])([0, 0], [0.4, 0], [0.6, 1], [1, 1], Object(_helpers_d8b49b57_js__WEBPACK_IMPORTED_MODULE_3__["c"])(0, adjustedStepValue, 0.9999))[0] || 0;
    ...
    class_1.prototype.beforeAnimation = function (shouldOpen) {
        Object(_helpers_d8b49b57_js__WEBPACK_IMPORTED_MODULE_3__["b"])(!this.isAnimating, '_before() should not be called while animating');
    ...
    class_1.prototype.afterAnimation = function (isOpen) {
        Object(_helpers_d8b49b57_js__WEBPACK_IMPORTED_MODULE_3__["b"])(this.isAnimating, '_before() should be called while animating');
    ...
    class_1.prototype.updateState = function () {
        ...
        if (!this.disabled) {
            _index_6941d9b4_js__WEBPACK_IMPORTED_MODULE_8__["m"]._setActiveMenu(this);
        }
        Object(_helpers_d8b49b57_js__WEBPACK_IMPORTED_MODULE_3__["b"])(!this.isAnimating, 'can not be animating');
    };
    class_1.prototype.forceClosing = function () {
        Object(_helpers_d8b49b57_js__WEBPACK_IMPORTED_MODULE_3__["b"])(this._isOpen, 'menu cannot be closed');
        this.isAnimating = true;
    ...
    class_1.prototype.render = function () {
        ...
        return (Object(_index_26ec602c_js__WEBPACK_IMPORTED_MODULE_1__["h"])(_index_26ec602c_js__WEBPACK_IMPORTED_MODULE_1__["H"], { role: "navigation", class: (_a = {},
                _a[mode] = true,
...
var updateVisibility = function (menu) { return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(void 0, void 0, void 0, function () {
    ...
    return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"])(this, function (_b) {
        switch (_b.label) {
            case 0: return [4 /*yield*/, _index_6941d9b4_js__WEBPACK_IMPORTED_MODULE_8__["m"].get(menu)];
            case 1:
                menuEl = _b.sent();
                _a = menuEl;
...
var MenuButton = /** @class */ (function () {
    function class_2(hostRef) {
        ...
        this.onClick = function () { return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"])(_this, void 0, void 0, function () {
            return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"])(this, function (_a) {
                return [2 /*return*/, _index_6941d9b4_js__WEBPACK_IMPORTED_MODULE_8__["m"].toggle(this.menu)];
            });
        }); };
    }
    ...
    class_2.prototype.render = function () {
        ...
        var mode = Object(_ionic_global_1bf1fa84_js__WEBPACK_IMPORTED_MODULE_2__["b"])(this);
        var menuIcon = _ionic_global_1bf1fa84_js__WEBPACK_IMPORTED_MODULE_2__["c"].get('menuIcon', mode === 'ios' ? 'menu-outline' : 'menu-sharp');
        var hidden = this.autoHide && !this.visible;
        var attrs = {
            type: this.type
        };
        return (Object(_index_26ec602c_js__WEBPACK_IMPORTED_MODULE_1__["h"])(_index_26ec602c_js__WEBPACK_IMPORTED_MODULE_1__["H"], { onClick: this.onClick, "aria-disabled": disabled ? 'true' : null, "aria-hidden": hidden ? 'true' : null, class: Object.assign(Object.assign((_a = {}, _a[mode] = true, _a), Object(_theme_c2dc54d9_js__WEBPACK_IMPORTED_MODULE_9__["c"])(color)), { 'button': true, 'menu-button-hidden': hidden, 'menu-button-disabled': disabled, 'in-toolbar': Object(_theme_c2dc54d9_js__WEBPACK_IMPORTED_MODULE_9__["h"])('ion-toolbar', this.el), 'in-toolbar-color': Object(_theme_c2dc54d9_js__WEBPACK_IMPORTED_MODULE_9__["h"])('ion-toolbar[color]', this.el), 'ion-activatable': true, 'ion-focusable': true }) }, Object(_index_26ec602c_js__WEBPACK_IMPORTED_MODULE_1__["h"])("button", Object.assign({}, attrs, { disabled: disabled, class: "button-native" }), Object(_index_26ec602c_js__WEBPACK_IMPORTED_MODULE_1__["h"])("span", { class: "button-inner" }, Object(_index_26ec602c_js__WEBPACK_IMPORTED_MODULE_1__["h"])("slot", null, Object(_index_26ec602c_js__WEBPACK_IMPORTED_MODULE_1__["h"])("ion-icon", { icon: menuIcon, mode: mode, lazy: false }))), mode === 'md' && Object(_index_26ec602c_js__WEBPACK_IMPORTED_MODULE_1__["h"])("ion-ripple-effect", { type: "unbounded" }))));
    };
...
var MenuToggle = /** @class */ (function () {
    function class_3(hostRef) {
        ...
        this.onClick = function () {
            return _index_6941d9b4_js__WEBPACK_IMPORTED_MODULE_8__["m"].toggle(_this.menu);
        };
    }
    ...
    class_3.prototype.render = function () {
        ...
        var mode = Object(_ionic_global_1bf1fa84_js__WEBPACK_IMPORTED_MODULE_2__["b"])(this);
        var hidden = this.autoHide && !this.visible;
        return (Object(_index_26ec602c_js__WEBPACK_IMPORTED_MODULE_1__["h"])(_index_26ec602c_js__WEBPACK_IMPORTED_MODULE_1__["H"], { onClick: this.onClick, "aria-hidden": hidden ? 'true' : null, class: (_a = {},
                _a[mode] = true,
                _a['menu-toggle-hidden'] = hidden,
                _a) }, Object(_index_26ec602c_js__WEBPACK_IMPORTED_MODULE_1__["h"])("slot", null)));
    };
    return class_3;
}());
