...
var ViewController = /** @class */ (function () {
    ...
    ViewController.prototype._destroy = function () {
        Object(_helpers_d8b49b57_js__WEBPACK_IMPORTED_MODULE_3__["b"])(this.state !== VIEW_STATE_DESTROYED, 'view state must be ATTACHED');
...
var Nav = /** @class */ (function () {
    ...
    class_1.prototype.componentWillLoad = function () {
        ...
        if (this.swipeGesture === undefined) {
            ...
            this.swipeGesture = _ionic_global_1bf1fa84_js__WEBPACK_IMPORTED_MODULE_2__["c"].getBoolean('swipeBackEnabled', mode === 'ios');
        }
    ...
    class_1.prototype.componentDidUnload = function () {
        for (var _i = 0, _a = this.views; _i < _a.length; _i++) {
            var view = _a[_i];
            Object(_index_e98418f5_js__WEBPACK_IMPORTED_MODULE_4__["l"])(view.element, _index_e98418f5_js__WEBPACK_IMPORTED_MODULE_4__["d"]);
            view._destroy();
        }
        if (this.gesture) {
    ...
    class_1.prototype.prepareTI = function (ti) {
        ...
        if (ti.removeView !== undefined) {
            Object(_helpers_d8b49b57_js__WEBPACK_IMPORTED_MODULE_3__["b"])(ti.removeStart !== undefined, 'removeView needs removeStart');
            Object(_helpers_d8b49b57_js__WEBPACK_IMPORTED_MODULE_3__["b"])(ti.removeCount !== undefined, 'removeView needs removeCount');
        ...
        Object(_helpers_d8b49b57_js__WEBPACK_IMPORTED_MODULE_3__["b"])(insertViews.length > 0, 'length can not be zero');
    ...
    class_1.prototype.postViewInit = function (enteringView, leavingView, ti) {
        Object(_helpers_d8b49b57_js__WEBPACK_IMPORTED_MODULE_3__["b"])(leavingView || enteringView, 'Both leavingView and enteringView are null');
        Object(_helpers_d8b49b57_js__WEBPACK_IMPORTED_MODULE_3__["b"])(ti.resolve, 'resolve must be valid');
        Object(_helpers_d8b49b57_js__WEBPACK_IMPORTED_MODULE_3__["b"])(ti.reject, 'reject must be valid');
        var opts = ti.opts;
        var insertViews = ti.insertViews;
        var removeStart = ti.removeStart;
        ...
        if (removeStart !== undefined && removeCount !== undefined) {
            Object(_helpers_d8b49b57_js__WEBPACK_IMPORTED_MODULE_3__["b"])(removeStart >= 0, 'removeStart can not be negative');
            Object(_helpers_d8b49b57_js__WEBPACK_IMPORTED_MODULE_3__["b"])(removeCount >= 0, 'removeCount can not be negative');
            destroyQueue = [];
        ...
        Object(_helpers_d8b49b57_js__WEBPACK_IMPORTED_MODULE_3__["b"])(finalBalance >= 0, 'final balance can not be negative');
        if (finalBalance === 0) {
        ...
        if (destroyQueue && destroyQueue.length > 0) {
            for (var _a = 0, destroyQueue_1 = destroyQueue; _a < destroyQueue_1.length; _a++) {
                ...
                Object(_index_e98418f5_js__WEBPACK_IMPORTED_MODULE_4__["l"])(view.element, _index_e98418f5_js__WEBPACK_IMPORTED_MODULE_4__["b"]);
                Object(_index_e98418f5_js__WEBPACK_IMPORTED_MODULE_4__["l"])(view.element, _index_e98418f5_js__WEBPACK_IMPORTED_MODULE_4__["c"]);
                Object(_index_e98418f5_js__WEBPACK_IMPORTED_MODULE_4__["l"])(view.element, _index_e98418f5_js__WEBPACK_IMPORTED_MODULE_4__["d"]);
            }
            ...
            return Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"])(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        animationOpts = Object.assign({ mode: mode, showGoBack: this.canGoBackSync(enteringView), baseEl: this.el, animationBuilder: this.animation || opts.animationBuilder || _ionic_global_1bf1fa84_js__WEBPACK_IMPORTED_MODULE_2__["c"].get('navAnimation'), progressCallback: progressCallback, animated: this.animated && _ionic_global_1bf1fa84_js__WEBPACK_IMPORTED_MODULE_2__["c"].getBoolean('animated', true), enteringEl: enteringEl,
                            leavingEl: leavingEl }, opts);
                        return [4 /*yield*/, Object(_index_e98418f5_js__WEBPACK_IMPORTED_MODULE_4__["t"])(animationOpts)];
                    case 1:
    ...
    class_1.prototype.insertViewAt = function (view, index) {
        ...
        if (existingIndex > -1) {
            ...
            Object(_helpers_d8b49b57_js__WEBPACK_IMPORTED_MODULE_3__["b"])(view.nav === this, 'view is not part of the nav');
            views.splice(index, 0, views.splice(existingIndex, 1)[0]);
        }
        else {
            Object(_helpers_d8b49b57_js__WEBPACK_IMPORTED_MODULE_3__["b"])(!view.nav, 'nav is used');
    ...
    class_1.prototype.removeView = function (view) {
        Object(_helpers_d8b49b57_js__WEBPACK_IMPORTED_MODULE_3__["b"])(view.state === VIEW_STATE_ATTACHED || view.state === VIEW_STATE_DESTROYED, 'view state should be loaded or destroyed');
        var views = this.views;
        var index = views.indexOf(view);
        Object(_helpers_d8b49b57_js__WEBPACK_IMPORTED_MODULE_3__["b"])(index > -1, 'view must be part of the stack');
        if (index >= 0) {
    ...
    class_1.prototype.cleanup = function (activeView) {
        ...
        for (var i = views.length - 1; i >= 0; i--) {
            ...
            if (i > activeViewIndex) {
                ...
                // let's unload it
                Object(_index_e98418f5_js__WEBPACK_IMPORTED_MODULE_4__["l"])(element, _index_e98418f5_js__WEBPACK_IMPORTED_MODULE_4__["d"]);
                this.destroyView(view);
            }
            else if (i < activeViewIndex) {
                // this view comes before the active view
                // and it is not a portal then ensure it is hidden
                Object(_index_e98418f5_js__WEBPACK_IMPORTED_MODULE_4__["s"])(element, true);
            }
        }
    };
...
var NavLink = /** @class */ (function () {
    ...
    NavLink.prototype.render = function () {
        return (Object(_index_26ec602c_js__WEBPACK_IMPORTED_MODULE_1__["h"])(_index_26ec602c_js__WEBPACK_IMPORTED_MODULE_1__["H"], { onClick: this.onClick }));
    };
