...
var AuthService = /** @class */ (function () {
    ...
    AuthService.prototype.register = function (body) {
        ...
        return this.http.post(this.urlRegister, body).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_5__["tap"])(function (res) {
            ...
            var urlUpdateUser = _this.urlUser + res.user.pk + '/';
            var bodyUpdateUser = {
                new_nric: res.user.username
            };
            return _this.http.put(urlUpdateUser, bodyUpdateUser).subscribe(function (res) { console.log('Update registered user: ', res); }, function (err) { console.log('Error update registered user: ', err); });
        }));
    };
