...
export class HouseDetailComponent implements OnInit {
  ...
  public tempImageData: [string, string, string, string, string, string, string] = [null, null, null, null, null, null, null]
  public tempImageEncoded: [string, string, string, string, string, string, string] = [null, null, null, null, null, null, null]
  ...
  async updateHouse() {
    ...
    this.houseService.update(this.houseCredentials.value, this.tempHouse.id).subscribe(
      (res) => {
