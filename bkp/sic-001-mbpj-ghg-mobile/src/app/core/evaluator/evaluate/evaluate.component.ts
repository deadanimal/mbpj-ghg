...
export class EvaluateComponent implements OnInit {
  ...
  a1Form = new FormGroup({
    ...
    evaluation_assessment_id: new FormControl('be6ef279-0439-4da3-b1ee-c29396dc7404')
  })
  a2Form = new FormGroup({
    ...
    efficiency: new FormControl(''),
    remarks: new FormControl(''),
    evaluation_assessment_id: new FormControl('425ca387-702e-4972-86ff-69ebed10d45a')
  })
  a3Form = new FormGroup({
    ...
    efficiency: new FormControl(''),
    remarks: new FormControl(''),
    evaluation_assessment_id: new FormControl('9c18a34e-21d9-4b1d-88c1-f3d19b5bfbe2')
  })
  a4Form = new FormGroup({
    ...
    efficiency: new FormControl(''),
    remarks: new FormControl(''),
    evaluation_assessment_id: new FormControl('7fa64288-0d73-4593-b1d8-4b47a448c273')
  })
  a5Form = new FormGroup({
    ...
    efficiency: new FormControl(''),
    remarks: new FormControl(''),
    evaluation_assessment_id: new FormControl('b23d0e1d-9bab-49b7-b755-ca70ffa2722f')
  })
  a6Form = new FormGroup({
    ...
    efficiency: new FormControl(''),
    remarks: new FormControl(''),
    evaluation_assessment_id: new FormControl('f651cbd1-03b3-49f1-9cba-892b9dd9285a')
  })
  b1Form = new FormGroup({
    ...
    efficiency: new FormControl(''),
    remarks: new FormControl(''),
    evaluation_assessment_id: new FormControl('6e055614-c429-4051-b6da-ed96246aabd6')
  })
  b2Form = new FormGroup({
    ...
    efficiency: new FormControl(''),
    remarks: new FormControl(''),
    evaluation_assessment_id: new FormControl('75bebeee-3233-46d7-ad20-4e7deb43d10f')
  })
  b3Form = new FormGroup({
    ...
    efficiency: new FormControl(''),
    remarks: new FormControl(''),
    evaluation_assessment_id: new FormControl('4391e0e3-52dd-4d70-9697-b80329681d5e')
  })
  b4Form = new FormGroup({
    ...
    efficiency: new FormControl(''),
    remarks: new FormControl(''),
    evaluation_assessment_id: new FormControl('49c98768-c26e-40bb-86c1-d82c645dc0d5')
  })
  b5Form = new FormGroup({
    ...
    efficiency: new FormControl(''),
    remarks: new FormControl(''),
    evaluation_assessment_id: new FormControl('0eeb7912-4be7-4e4a-99f5-e97c4a7fbae2')
  })
...
/*
  onConfirm(){
    this.applicationEvaluationService.doCreateApplicationEvaluation(this.a1Form.value).subscribe(
      () => {
        this.successfulToast()
      },
      () => {
    ...
    this.applicationEvaluationService.doCreateApplicationEvaluation(this.a2Form.value).subscribe(
      () => {
    ...
    this.applicationEvaluationService.doCreateApplicationEvaluation(this.a3Form.value).subscribe(
      () => {
      },
      () => {
      }
    )
    this.applicationEvaluationService.doCreateApplicationEvaluation(this.a4Form.value).subscribe(
      () => {
      },
      () => {
      }
    )
    this.applicationEvaluationService.doCreateApplicationEvaluation(this.a5Form.value).subscribe(
      () => {
      },
      () => {
      }
    )
    this.applicationEvaluationService.doCreateApplicationEvaluation(this.a6Form.value).subscribe(
      () => {
      },
      () => {
      }
    )
    this.applicationEvaluationService.doCreateApplicationEvaluation(this.b1Form.value).subscribe(
      () => {
      },
      () => {
      }
    )
    this.applicationEvaluationService.doCreateApplicationEvaluation(this.b2Form.value).subscribe(
      () => {
      },
      () => {
      }
    )
    this.applicationEvaluationService.doCreateApplicationEvaluation(this.b3Form.value).subscribe(
      () => {
      },
      () => {
      }
    )
    this.applicationEvaluationService.doCreateApplicationEvaluation(this.b4Form.value).subscribe(
      () => {
      },
      () => {
      }
    )
    this.applicationEvaluationService.doCreateApplicationEvaluation(this.b5Form.value).subscribe(
      () => {
      },
      () => {
      }
    ...
    this.applicationService.doUpdateApplication(updateApp, this.tempApplication.id).subscribe(
      () => {},
      () => {},
      () => {}
    )
