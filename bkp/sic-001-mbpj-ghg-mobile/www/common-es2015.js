...
let EvaluationSchedulesService = class EvaluationSchedulesService {
    constructor(http) {
        this.http = http;
        // URL
    ...
    create(body) {
        return this.http.post(this.urlSchedule, body).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["tap"])((res) => {
            console.log('Create evaluation schedule response: ', res);
        }));
    }
    get() {
        return this.http.get(this.urlSchedule).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["tap"])((res) => {
            this.schedules = res;
...
EvaluationSchedulesService.ctorParameters = () => [
...
let FaqsService = class FaqsService {
    ...
    get() {
        return this.http.get(this.urlFaq).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["tap"])((res) => {
            this.faqs = res;
