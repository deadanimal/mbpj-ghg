...
let HistoryViewComponent = class HistoryViewComponent {
    constructor(alertCtrl, route, router, applicationassessmentService, assessmentaspectService, evaluationService) {
        this.alertCtrl = alertCtrl;
        this.route = route;
        this.router = router;
        this.applicationassessmentService = applicationassessmentService;
...
let HistoryComponent = class HistoryComponent {
    ...
    getData() {
        this.applicationService.getApplicantDetail().subscribe((res) => {
...
let ProfileComponent = class ProfileComponent {
    ...
    getData() {
        ...
        this.userForm.patchValue(Object.assign({}, this.user));
