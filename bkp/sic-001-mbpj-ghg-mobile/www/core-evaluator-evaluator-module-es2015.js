...
let ApplicationAssessmentComponent = class ApplicationAssessmentComponent {
    constructor() { }
    ngOnInit() { }
};
...
let ApplicationDetailComponent = class ApplicationDetailComponent {
    constructor(authService, applicationService, 
    ...
    doSetEvaluation() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            ...
            let formatedDate = moment__WEBPACK_IMPORTED_MODULE_2__(new Date(this.evaluationForm.value.date)).format("YYYY-MM-DD");
...
let ApplicationEvaluationComponent = class ApplicationEvaluationComponent {
    constructor() { }
    ngOnInit() { }
};
...
module.exports = ".evaluation-list {\n  --inner-padding-end: 0;\n  --inner-padding-start: 0;\n  --padding-end: 0;\n  --padding-start: 0;\n}\n/*# sourceMappingURL=data:application/json;base64, */"
...
class MergedNominatedApplication {
    constructor(id, applicant, evaluator_nominated, applied_house, status, date_submitted, applied_house_address, applicant_full_name, schedule_date, schedule_session) {
        this.id = id;
...
MergedNominatedApplication.ctorParameters = () => [
    { type: String },
    { type: String },
    { type: String },
    { type: String },
...
let ApplicationComponent = class ApplicationComponent {
    constructor(authService, applicationService, evaluationScheduleService, houseService, alertController, router) {
        this.authService = authService;
        this.applicationService = applicationService;
    ...
    ngOnInit() {
        ...
        this.loadedNominatedApplications.forEach((application) => {
    ...
    ionViewDidEnter() {
        ...
        this.loadedNominatedApplications.forEach((application) => {
            this.houseService.houses.forEach((house) => {
                if (application.applied_house == house.id) {
                    if (application.status == 'IE') {
                        ...
                        this.authService.users.forEach((applicant) => {
                            if (applicant.id == application.applicant) {
                                //this.loadedNominatedApplicant.push(applicant)
                                this.evaluationScheduleService.schedules.forEach((schedule) => {
    ...
    doStartEvaluate(house) {
        console.log(house);
        let application;
        this.loadedNominatedApplications.forEach((data) => {
...
let EvaluateComponent = class EvaluateComponent {
    constructor(authService, applicationService, applicationAssessmentService, evaluationService, houseService, camera, alertController, router, toastr) {
        this.authService = authService;
        this.applicationService = applicationService;
    ...
    initData() {
        ...
        this.applicationAssessmentService.assessments.forEach((data) => {
    ...
    doEvalute() {
        let todayDate = moment__WEBPACK_IMPORTED_MODULE_3__(new Date()).format("YYYY-MM-DD");
...
EvaluateComponent.ctorParameters = () => [
...
let EvaluatorModule = class EvaluatorModule {
};
...
module.exports = ".ticket-list {\n  --inner-padding-end: 0;\n  --inner-padding-start: 0;\n  --padding-end: 0;\n  --padding-start: 0;\n  --padding-top: 1rem;\n  --padding-bottom: 0.5rem;\n}\n/*# sourceMappingURL=data:application/json;base64, */"
...
let HelpdeskComponent = class HelpdeskComponent {
    constructor(authService, ticketAnswerService, ticketQuestionService, alertController, loadingController, toastController, router, translate) {
        this.authService = authService;
...
module.exports = ".history-list {\n  --inner-padding-end: 0;\n  --inner-padding-start: 0;\n  --padding-end: 0;\n  --padding-start: 0;\n}\n/*# sourceMappingURL=data:application/json;base64, */"
...
let HistoryComponent = class HistoryComponent {
    ...
    initData() {
        ...
        this.evaluatedApplications.forEach((application) => {
            this.houseService.houses.forEach((house) => {
                if (application.applied_house == house.id) {
                    this.loadedNominatedHouses.push(house);
...
let HomeComponent = class HomeComponent {
    constructor(authService, applicationService, houseService, alertCtrl, router) {
        this.authService = authService;
        this.applicationService = applicationService;
        this.houseService = houseService;
...
let ProfileComponent = class ProfileComponent {
    constructor(authService, toastController, router, actionSheetController, alertController, base64, loadingController, camera, translate, formBuilder, notifyService) {
        this.authService = authService;
        this.toastController = toastController;
        this.router = router;
    ...
    encodeFile64() {
        this.base64.encodeFile(this.tempImageData).then((base64File) => {
...
let ScheduleComponent = class ScheduleComponent {
    constructor(authService, applicationService, houseService, alertController, router) {
        this.authService = authService;
        this.applicationService = applicationService;
        this.houseService = houseService;
        this.alertController = alertController;
...
class MergedApplicationAssessment {
    constructor(id, application, assessment_aspect, remarks, supporting_doc, aspect_name, aspect_type, aspect_id, aspect) {
        this.id = id;
...
MergedApplicationAssessment.ctorParameters = () => [
    { type: String },
    { type: String },
    { type: String },
    { type: String },
...
let TestComponent = class TestComponent {
    constructor(authService, applicationService, applicationAssessmentService, assessmentAspectService, evaluationService, houseService, alertController, router, formBuilder) {
        this.authService = authService;
        this.applicationService = applicationService;
        this.applicationAssessmentService = applicationAssessmentService;
    ...
    ngOnInit() {
        ...
        this.applicationAssessmentService.assessments.forEach((data) => {
            if (data.application == this.tempApplication.id) {
                this.assessmentAspectService.retrievedAssessmentAspects.forEach((aspect, index) => {
                    ...
                    if (this.assessmentAspectService.retrievedAssessmentAspects.length === index + 1) {
                        this.tempApplicationAssessment.forEach((assessment) => {
...
//# sourceMappingURL=core-evaluator-evaluator-module-es2015.js.map